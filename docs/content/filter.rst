...
To edit or create a filter, go to the Administration section and click on the "Filter" icon.
...
Click in the search bar and start typing the name of the filter you wish to edit: the list will progressively reduce itself, thus facilitating the research.
...
If you wish to change the color of the filter used in the graph, click on the color selection icon. If changes have been performed and you want to keep them, don't forget to click on the blue "Save" button.
