...
//        ],
    ...
    private $filters = [
        'Tables_W' => [
            0 => ["GLASS", null],
            1 => ["Water", 0],
            9 => ["Level of development and implementation of policy / plan", 1], // kind of unique parent to avoid conflits between other Drinking water supply filters and this one
            10 => ["Drinking-water supply", 9],
            11 => ["Target coverage", 10],
            12 => ["Target year", 10],
            13 => ["Level of development / Implementation of plan", 10],
            20 => ["Drinking-water in schools", 9],
            21 => ["Target coverage", 20],
            22 => ["Target year", 20],
            23 => ["Level of development / Implementation of plan", 20],
            30 => ["Drinking-water in health facilities", 9],
            31 => ["Target coverage", 30],
            32 => ["Target year", 30],
            33 => ["Level of development / Implementation of plan", 30],
            40 => ["To keep rural water supplies functioning over the long-term", 1],
            41 => ["To improve the reliability and continuity of urban water supplies", 1],
            42 => ["To ensure drinking water quality meet national standards", 1],
            50 => ["Formal", 1],
            51 => ["Community-based", 1],
            52 => ["Informal", 1],
            53 => ["Self-supply", 1],
            60 => ["Ministry1", 1],
            61 => ["Govern/Regulate", 60],
            62 => ["Provide Service", 60],
            63 => ["Monitor/Survie", 60],
            70 => ["Ministry2", 1],
            71 => ["Govern/Regulate", 70],
            72 => ["Provide Service", 70],
            73 => ["Monitor/Survie", 70],
            80 => ["Ministry3", 1],
            81 => ["Govern/Regulate", 80],
            82 => ["Provide Service", 80],
            83 => ["Monitor/Survie", 80],
            90 => ["Ministry4", 1],
            91 => ["Govern/Regulate", 90],
            92 => ["Provide Service", 90],
            93 => ["Monitor/Survie", 90],
            100 => ["Ministry5", 1],
            101 => ["Govern/Regulate", 100],
            102 => ["Provide Service", 100],
            103 => ["Monitor/Survie", 100],
            110 => ["Poor populations", 1],
            111 => ["Populations living in slums or informal settlements", 1],
            112 => ["Remote or hard to reach areas	", 1],
            113 => ["Indigenous population", 1],
            114 => ["Internally displaced", 1],
            115 => ["Ethnic minorities", 1],
            116 => ["People with disabilities", 1],
            117 => ["Other disadvantaged groups name", 1],
            118 => ["Other disadvantaged groups", 1],
            120 => ["Expenditure", 1],
            121 => ["Service quality", 1],
            122 => ["Equitable Service", 1],
            123 => ["Cost Effectiveness", 1],
            124 => ["Functionality of systems", 1],
            125 => ["Affordability", 1],
            // 126  => array("Wastewater/septage reuse", 1), // not for water
            127 => ["Institutional effectiveness", 1],
            128 => ["Cost-Recovery", 1],
            130 => ["Policy and strategy", 1],
            131 => ["Resource allocation", 1],
            132 => ["National standards", 1],
            140 => ["WASH HR strategy exists", 1], //
            141 => ["Current difficulties in HR for WASH", 1],
            142 => ["Financial resources available for staff (salaries and benefits, including pensions etc.) ", 1],
            143 => ["Insufficient education/training organisations or courses to meet demand by potential students", 1],
            144 => ["Lack of skilled graduates from training & education institutes", 1],
            145 => ["Preference by skilled graduates to work in other (non-WASH) sectors (e.g. Mining, Transport, Construction) within the country", 1],
            146 => ["Emigration (temporary or permanent) of skilled workers to work abroad", 1],
            147 => ["Skilled workers do not want to live and work in rural areas of the country", 1],
            148 => ["Recruitment practices", 1],
            149 => ["Other (please specify)", 1],
            150 => ["Central government", 1],
            151 => ["Bilateral, multilateral donors", 1],
            152 => ["State, provincial, local", 1],
            153 => ["Tariffs and charges", 1],
            154 => ["Households out-of-pocket", 1],
            155 => ["NGOs, Lendors, Other", 1],
            160 => ["Household tariffs for services provided", 1, 170],
            161 => ["Household out-of-pocket expenditure for self-supply", 1, 171],
            162 => ["Government or public authority at Central level", 1, 172],
            163 => ["Government or public authority at State / provincial level", 1, 172],
            164 => ["Government or public authority at Local level", 1, 173],
            165 => ["External sources: International public transfers (ODA)", 1, 174],
            166 => ["External sources: Voluntary transfers (NGOs and foundations)", 1, 175],
            1105 => ["Drinking-water in schools", 1],
            1106 => ["Drinking-water in health facilities", 1],
        ],
        'Tables_S' => [
            0 => ["GLASS", null],
            1 => ["Sanitation", 0],
            9 => ["Level of development and implementation of policy / plan", 1], // kind of unique parent to avoid conflits between other Sanitation filters and this one
            10 => ["Sanitation", 9],
            11 => ["Target coverage", 10],
            12 => ["Target year", 10],
            13 => ["Level of development / Implementation of plan", 10],
            20 => ["Sanitation in schools", 9],
            21 => ["Target coverage", 20],
            22 => ["Target year", 20],
            23 => ["Level of development / Implementation of plan", 20],
            30 => ["Sanitation in health facilities", 9],
            31 => ["Target coverage", 30],
            32 => ["Target year", 30],
            33 => ["Level of development / Implementation of plan", 30],
            40 => ["To rehabilitate broken or disused public latrines  (e.g. in schools)", 1],
            41 => ["To safely empty or replace latrines when full ", 1],
            42 => ["To reuse wastewater and/or septage", 1],
            50 => ["Formal", 1],
            51 => ["Community-based", 1],
            52 => ["Informal", 1],
            53 => ["Self-supply", 1],
            ...
            115 => ["Ethnic minorities", 1],
            116 => ["People with disabilities", 1],
            117 => ["Other disadvantaged groups", 1],
            118 => ["Other disadvantaged groups", 1],
            120 => ["Expenditure", 1],
            121 => ["Service quality", 1],
            122 => ["Equitable Service", 1],
            ...
            124 => ["Functionality of systems", 1],
            125 => ["Affordability", 1],
            126 => ["Wastewater/septage reuse", 1],
            127 => ["Institutional effectiveness", 1],
            128 => ["Cost-Recovery", 1],
            130 => ["Policy and strategy", 1],
            131 => ["Resource allocation", 1],
        ...
        'Tables_H' => [
            0 => ["GLASS", null],
            1 => ["Hygiene", 0],
            9 => ["Level of development and implementation of policy / plan", 1], // kind of unique parent to avoid conflits between other Hygiene promotio filters and this one
            10 => ["Hygiene promotion", 9],
            11 => ["Target coverage", 10],
            12 => ["Target year", 10],
            13 => ["Level of development / Implementation of plan", 10],
            20 => ["Hygiene promotion in schools", 9],
            21 => ["Target coverage", 20],
            22 => ["Target year", 20],
            23 => ["Level of development / Implementation of plan", 20],
            30 => ["Hygiene promotion in health facilities", 9],
            31 => ["Target coverage", 30],
            32 => ["Target year", 30],
            33 => ["Level of development / Implementation of plan", 30],
            60 => ["Ministry1", 1],
...
//            1130 => array("Ministry of Education", 1),
        ...
        'Tables_U' => [
            0 => ["GLASS", null],
            1 => ["Undefined", 0],
            40 => ["To address resilience to climate change", 1],
            110 => ["Poor populations", 1],
            111 => ["Populations living in slums or informal settlements", 1],
            112 => ["Remote or hard to reach areas	", 1],
            113 => ["Indigenous population", 1],
            ...
            117 => ["Other disadvantaged groups", 1],
            118 => ["Other disadvantaged groups", 1],
            130 => ["Identify public health priorities", 1],
            131 => ["Response to WASH related disease outbreak", 1],
            160 => ["Household tariffs for services provided", 1, 170],
            161 => ["Household out-of-pocket expenditure for self-supply", 1, 171],
            162 => ["Government or public authority at Central level", 1, 172],
            163 => ["Government or public authority at State / provincial level", 162, 172],
            164 => ["Government or public authority at Local level", 162, 173],
            165 => ["External sources: International public transfers (ODA)", 1, 174],
            166 => ["External sources: Voluntary transfers (NGOs and foundations)", 1, 175],
            // totals
            170 => ["Central Government", 1],
            171 => ["Bilateral, multilateral donors", 1],
            172 => ["State, provincial, local", 1],
            173 => ["Tariffs and charges", 1],
            174 => ["Households’ out-of-pocket", 1],
            175 => ["NGOs, Lendors, Other", 1],
