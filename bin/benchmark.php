...
function getUrls()
{
    ...
    $water = '76,77,78,79,80';
    $sanitation = '167,168,169,170,171,172';
    $urls = array(
        'questionnaire/structure Water Bangladesh                     ' => "http://$hostname.lan/api/questionnaire/structure?id=$questionnairesForBangladesh",
