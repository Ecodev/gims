...
class Version20130822110915 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE part (id SERIAL NOT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, date_created TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, date_modified TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, name TEXT NOT NULL, is_total BOOLEAN DEFAULT 'false' NOT NULL, PRIMARY KEY(id))");
