 ...
 */
class Version20130430152001 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE population (id SERIAL NOT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, country_id INT NOT NULL, part_id INT DEFAULT NULL, date_created TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, date_modified TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, year NUMERIC(4, 0) NOT NULL, population INT NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("CREATE TABLE filter (id SERIAL NOT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, official_filter_id INT DEFAULT NULL, date_created TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, date_modified TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, name TEXT NOT NULL, is_official BOOLEAN NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("CREATE TABLE question (id SERIAL NOT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, filter_id INT NOT NULL, official_question_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, survey_id INT NOT NULL, date_created TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, date_modified TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, sorting SMALLINT NOT NULL, type VARCHAR(255) NOT NULL, name TEXT NOT NULL, has_parts BOOLEAN NOT NULL, PRIMARY KEY(id))");
        ...
        $this->addSql("ALTER TABLE filter_rule ADD CONSTRAINT FK_2EE2CBB561220EA6 FOREIGN KEY (creator_id) REFERENCES \"user\" (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE");
        $this->addSql("ALTER TABLE filter_rule ADD CONSTRAINT FK_2EE2CBB5D079F553 FOREIGN KEY (modifier_id) REFERENCES \"user\" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE");
        ...
        $this->addSql("ALTER TABLE filter_children ADD CONSTRAINT FK_9CF8B41A2A4D2D2 FOREIGN KEY (child_filter_id) REFERENCES filter (id) NOT DEFERRABLE INITIALLY IMMEDIATE");
        ...
        $this->addSql("ALTER TABLE filter_set ADD CONSTRAINT FK_1C0A40E61220EA6 FOREIGN KEY (creator_id) REFERENCES \"user\" (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE");
        $this->addSql("ALTER TABLE filter_set ADD CONSTRAINT FK_1C0A40ED079F553 FOREIGN KEY (modifier_id) REFERENCES \"user\" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE");
        ...
        $this->addSql("ALTER TABLE question ADD CONSTRAINT FK_B6F7494ED395B25E FOREIGN KEY (filter_id) REFERENCES filter (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE");
