 ...
 */
class Version20130911103847 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE answer DROP is_checkbox_checked");
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE answer ADD is_checkbox_checked BOOLEAN DEFAULT 'false'");
    }
}
