 ...
 */
class Version20130228173553 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE country ADD CONSTRAINT FK_5373C966A5AE06FA FOREIGN KEY (geonameid_id) REFERENCES geoname (id) NOT DEFERRABLE INITIALLY IMMEDIATE");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE country DROP CONSTRAINT FK_5373C966A5AE06FA");
